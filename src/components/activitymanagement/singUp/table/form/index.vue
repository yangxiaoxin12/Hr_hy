    ...
    >
      <el-form :model="prize">
        ...
        <el-form-item label="中奖限制" :label-width="formLabelWidth">
          <el-col :span="22">
             <el-input v-model="prize.prizeLimit" autocomplete="off"></el-input>
          </el-col>
          <el-col :span="2">人</el-col>
        </el-form-item>
        <el-form-item label="消耗积分" :label-width="formLabelWidth">
          <el-col :span="22">
          <el-input v-model="prize.consumeIntegral" autocomplete="off"></el-input>
           </el-col>
        ...
        <el-form-item label="图片路径" style="margin-top:40px;" :label-width="formLabelWidth">
          <!-- <el-input v-model="prize.image" autocomplete="off"></el-input> -->
