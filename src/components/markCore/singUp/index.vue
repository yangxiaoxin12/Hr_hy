    ...
    <div class="content">
      <el-form ref="theme" :rules="rules" :model="theme">
        ...
        <el-form-item label-width="100px" class="restCss" p label="媒资信息:">
          ...
          <el-col :span="2">
              <el-button type="primary" style="margin-left:150px;" @click="onSearch" icon="el-icon-search" circl></el-button>
          </el-col>
        </el-form-item>
        ...
        <el-form-item label-width="100px" label="签到规则:" prop="remark">
