...
export default {
  ...
  methods: {
    handleEdit(row, i) {
      ...
      if (i == 0) {
        link.href = "../../../static/znzz_/01.docx";
        link.setAttribute("download", "采购模型建设.docx");
      }
      if (i == 1) {
        link.href = "../../../static/znzz_/02.docx";
        link.setAttribute("download", "131C10塔异常情况说明与处理措施.docx");
      }
      if (i == 2) {
        link.href = "../../../static/znzz_/03.docx";
        link.setAttribute("download", "敏捷开发经验.docx");
      }
