/* eslint-disable semi */
<template>
  <div class="userPointList">
    <div class="main-header">
      <el-form :inline="true" :model="userForm" label-width="100px" class="demo-form-inline">
        ...
        <el-form-item>
          <el-button class="searchCss" type="success" @click="getList">查询</el-button>
      ...
      >
        ...
        <el-table-column prop="integral" sortable label="总积分"></el-table-column>
    ...
    <memberDetail :show.sync="show" :curRow.sync="curRow"  @showValue="showValue" />
    <pagination
      v-show="total>0"
      :total="total"
