    ...
    // },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: "zhongjiang",
          component: resolve =>
            require(["@/components/activityStatistics/zhongjiang.vue"], resolve)
        },
        {
          path: "/tongji",
          name: "tongji",
          component: resolve =>
            require(["@/components/activityStatistics/tongji.vue"], resolve)
        },
        {
          path: "/roleManagement",
          name: "roleManagement",
        ...
        },
        {
          ...
          component: resolve =>
            require([
              "@/components/activityStatistics/votingStatistics.vue"
            ], resolve)
        },
        {
          path: "/account",
        ...
        },
        {
          ...
          component: resolve =>
            require([
              "@/components/activityStatistics/activityParticipation.vue"
            ], resolve)
        },
        {
          path: "/votingDvetails",
